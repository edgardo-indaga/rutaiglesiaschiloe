...
import DetifPhotoGallery from '@components/GalleryChurch/DetifPhotoGallery';
    ...
    return (
        <main>
            ...
            <section className="px-5 py-10 md:py-[100px] md:px-0">
                ...
                <div className="container mx-auto flex flex-col md:flex-row pt-10 md:pt-[70px]">
                    <div className="w-full md:w-4/12 flex md:flex-col items-center mb-5 md:mb-0">
                        ...
                        />
                        <p className="font-thin text-tinto text-[18px] md:text-center md:w-[300px] md:text-[26px] md:leading-[34px] md:ml-[30px] md:mr-[20px] ml-[42px]">
                ...
                <div className="container mx-auto md:px-20">
                    ...
                    <p className="font-thin text-tinto text-[18px] mb-[20px] leading-normal md:text-[26px] md:leading-[34px] md:mb-[25px]">
                        <b>
                            ...
                            Mundial, su tamaño no le resta encanto, sino que la hace aún más
                            acogedora.
                        </b>
                    ...
                    <p className="font-thin text-tinto text-[18px] mb-[20px] leading-normal md:text-[26px] md:leading-[34px] md:mb-[25px]">
                        ...
                        que cuelgan de la nave principal.{' '}
                        <b>
                            Se cuenta que estos barcos fueron instalados como ofrenda por navegantes
                            locales que regresaron con vida,
                        </b>
            ...
            <section className="md:pt-[100px] px-5 py-10 md:px-0">
                ...
                >
                    <Link href="/recorridos/iglesia-detif/index.html" target={'_blank'}>
                        <Image
            ...
            <section className="md:py-[100px] md:h-auto px-5 py-10 md:px-0">
                <div className="container mx-auto">
                    <GalleryChurch slides={DetifPhotoGallery} rowHeight={200} />
                </div>
