            ...
            <section className="md:py-[100px]">
                ...
                <div className="container mx-auto md:mt-[70px]">
                    <p className="font-thin text-tinto md:text-[26px] md:leading-[34px] md:mb-[25px]">
                        ...
                        años. Recién la 1.920 la comunidad logró finalizar el proyecto. Las maderas
                        para su construcción fueron llevadas desde Dalcahue en yuntas de bueyes y
                        balsas a remo.
                    </p>
                    <p className="font-thin text-tinto md:text-[26px] md:leading-[34px] md:mb-[25px]">
                        Combina diferentes estilos y está construida con diversas maderas nativas,
                        como tepa, ulmo, tineo y alerce. Destaca su colorida bóveda de crucerías,
                        característica de la arquitectura gótica. Estas bóvedas se construyen
                        mediante la intersección de dos o más arcos que se cruzan y se entrelazan en
                        el techo, creando una estructura compleja y muy decorativa.
                    </p>
                    <p className="font-thin text-tinto md:text-[26px] md:leading-[34px] md:mb-[25px]">
                        Junto a la Virgen de Lourdes, además de la bandera chilena se expone una
                        bandera huilliche, en reconocimiento de este pueblo originario que fue clave
                        en la construcción de las iglesias chilotas y que influyó fuertemente en los
                        ritos y tradiciones que se desarrollan en torno a ellas.
                    </p>
                </div>
            </section>
            <section>
